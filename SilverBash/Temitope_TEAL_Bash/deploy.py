# This is a reference script that deploys the voting application 
...
# Enter Creator and User mnemonic
creator_mnemonic = "they lounge cost original among unaware permit myself rain bar smart whale senior today orbit manage resist enough name wage embrace memory embark edit down"
user_mnemonic = "cigar stable sniff ketchup cupboard news cargo admit unhappy mean garment inherit edit kangaroo ball hamster twin sphere warm dragon gossip jaguar provide genius blow"

# Declaring Algod parameters, Node must have EnableDeveloperAPI set to true in its config
